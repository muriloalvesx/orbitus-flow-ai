        ...
        <div className="bg-card rounded-2xl p-8 md:p-12 shadow-card border border-border/50 overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div 
                key={index} 
                className="flex flex-col items-center text-center space-y-4 p-6 rounded-xl bg-gradient-secondary border border-border/30 hover:border-primary/50 transition-all duration-300 hover:shadow-card"
              >
